...
This section is generated from the codebase (not hand-curated). It is intended to be machine-verifiable and can be regenerated with:

```bash
grep -RInE "do_action\(\s*['" ]apd_[^'"]+['"]" src templates includes \\
  | sed -E "s#^([^:]+):([0-9]+):.*do_action\(\s*['"](apd_[^'"]+)['"].*#\3 | \1:\2#" \\
  | sort -u
```

> Format: `hook_name | file:line`

- `apd_activated | src/Core/Activator.php:48`
- `apd_after_admin_fields | src/Fields/FieldRenderer.php:816`
- `apd_after_ajax_filter | src/Api/AjaxHandler.php:171`
...
- `apd_after_delete_demo_data | src/Admin/DemoData/DemoDataPage.php:688`
- `apd_after_delete_demo_data | src/Admin/DemoData/DemoDataTracker.php:771`
- `apd_after_delete_listing | src/Frontend/Dashboard/MyListings.php:533`
- `apd_after_edit_not_allowed | templates/submission/edit-not-allowed.php:63`
- `apd_after_filters | src/Search/FilterRenderer.php:207`
- `apd_after_filters | templates/search/search-form.php:58`
- `apd_after_frontend_fields | src/Fields/FieldRenderer.php:879`
- `apd_after_generate_demo_data | src/Admin/DemoData/DemoDataPage.php:625`
- `apd_after_generate_demo_data | src/CLI/DemoDataCommand.php:331`
- `apd_after_get_template | src/Core/Template.php:200`
- `apd_after_listing_save | src/Admin/ListingMetaBox.php:228`
- `apd_after_listings_shortcode | src/Shortcode/ListingsShortcode.php:259`
- `apd_after_login_form_shortcode | src/Shortcode/LoginFormShortcode.php:180`
- `apd_after_register_form_shortcode | src/Shortcode/RegisterFormShortcode.php:165`
- `apd_after_related_listings | templates/single-listing.php:404`
- `apd_after_review_form | templates/review/review-form.php:328`
- `apd_after_reviews_section | src/Review/ReviewForm.php:182`
- `apd_after_save_profile | src/Frontend/Dashboard/Profile.php:538`
- `apd_after_search_form | src/Search/FilterRenderer.php:160`
- `apd_after_search_form_shortcode | src/Shortcode/SearchFormShortcode.php:192`
...
- `apd_after_submission_form_shortcode | src/Shortcode/SubmissionFormShortcode.php:250`
- `apd_after_submission_success | templates/submission/submission-success.php:111`
- `apd_after_trash_listing | src/Frontend/Dashboard/MyListings.php:574`
- `apd_after_validate_fields | src/Fields/FieldValidator.php:257`
- `apd_all_ratings_recalculated | src/Review/RatingCalculator.php:314`
- `apd_archive_wrapper_end | templates/archive-listing.php:169`
- `apd_archive_wrapper_start | templates/archive-listing.php:44`
- `apd_avatar_uploaded | src/Frontend/Dashboard/Profile.php:608`
- `apd_before_ajax_filter | src/Api/AjaxHandler.php:87`
...
- `apd_before_delete_demo_data | src/Admin/DemoData/DemoDataPage.php:677`
- `apd_before_delete_demo_data | src/Admin/DemoData/DemoDataTracker.php:742`
- `apd_before_delete_listing | src/Frontend/Dashboard/MyListings.php:520`
- `apd_before_filters | src/Search/FilterRenderer.php:192`
- `apd_before_filters | templates/search/search-form.php:40`
- `apd_before_generate_demo_data | src/Admin/DemoData/DemoDataPage.php:603`
- `apd_before_generate_demo_data | src/CLI/DemoDataCommand.php:199`
- `apd_before_get_template | src/Core/Template.php:187`
- `apd_before_inquiry_delete | src/Contact/InquiryTracker.php:557`
- `apd_before_listing_save | src/Admin/ListingMetaBox.php:200`
- `apd_before_listing_update | src/Frontend/Submission/SubmissionHandler.php:729`
- `apd_before_listings_shortcode | src/Shortcode/ListingsShortcode.php:236`
- `apd_before_login_form_shortcode | src/Shortcode/LoginFormShortcode.php:162`
- `apd_before_register_form_shortcode | src/Shortcode/RegisterFormShortcode.php:139`
- `apd_before_related_listings | templates/single-listing.php:378`
- `apd_before_review_create | src/Review/ReviewManager.php:269`
- `apd_before_review_delete | src/Review/ReviewManager.php:435`
- `apd_before_review_form | templates/review/review-form.php:74`
- `apd_before_review_process | src/Review/ReviewHandler.php:337`
- `apd_before_review_update | src/Review/ReviewManager.php:374`
- `apd_before_reviews_section | src/Review/ReviewForm.php:170`
- `apd_before_save_profile | src/Frontend/Dashboard/Profile.php:487`
- `apd_before_search_form | src/Search/FilterRenderer.php:98`
- `apd_before_search_form_shortcode | src/Shortcode/SearchFormShortcode.php:172`
- `apd_before_send_contact | src/Contact/ContactHandler.php:227`
...
- `apd_before_submission_form_shortcode | src/Shortcode/SubmissionFormShortcode.php:236`
- `apd_before_trash_listing | src/Frontend/Dashboard/MyListings.php:561`
- `apd_block_registered | src/Blocks/BlockManager.php:193`
- `apd_block_unregistered | src/Blocks/BlockManager.php:225`
- `apd_blocks_init | src/Blocks/BlockManager.php:162`
- `apd_cache_cleared | src/Core/Performance.php:726`
- `apd_category_cache_invalidated | src/Core/Performance.php:595`
- `apd_contact_form_after_fields | templates/contact/contact-form.php:186`
- `apd_contact_form_init | src/Contact/ContactForm.php:135`
- `apd_contact_handler_init | src/Contact/ContactHandler.php:116`
- `apd_contact_sent | src/Contact/ContactHandler.php:247`
- `apd_dashboard_after_content | src/Frontend/Dashboard/Dashboard.php:513`
- `apd_dashboard_before_content | src/Frontend/Dashboard/Dashboard.php:475`
- `apd_dashboard_end | templates/dashboard/dashboard.php:89`
- `apd_dashboard_start | templates/dashboard/dashboard.php:39`
- `apd_dashboard_{$tab}_content | src/Frontend/Dashboard/Dashboard.php:487`
- `apd_deactivated | src/Core/Deactivator.php:33`
- `apd_demo_data_init | src/Admin/DemoData/DemoDataPage.php:146`
- `apd_demo_provider_registered | src/Admin/DemoData/DemoDataProviderRegistry.php:164`
- `apd_demo_provider_unregistered | src/Admin/DemoData/DemoDataProviderRegistry.php:195`
- `apd_demo_providers_init | src/Admin/DemoData/DemoDataProviderRegistry.php:113`
- `apd_email_manager_init | src/Email/EmailManager.php:144`
- `apd_favorite_added | src/User/Favorites.php:189`
- `apd_favorite_added | src/User/Favorites.php:800`
- `apd_favorite_removed | src/User/Favorites.php:244`
- `apd_favorite_removed | src/User/Favorites.php:837`
- `apd_favorites_cleared | src/User/Favorites.php:397`
- `apd_favorites_cleared | src/User/Favorites.php:911`
- `apd_favorites_end | templates/dashboard/favorites.php:134`
- `apd_favorites_init | src/User/Favorites.php:131`
- `apd_favorites_start | templates/dashboard/favorites.php:39`
- `apd_field_registered | src/Fields/FieldRegistry.php:258`
- `apd_field_type_registered | src/Fields/FieldRegistry.php:147`
- `apd_field_unregistered | src/Fields/FieldRegistry.php:289`
- `apd_filter_registered | src/Search/FilterRegistry.php:153`
- `apd_filter_unregistered | src/Search/FilterRegistry.php:184`
- `apd_init | src/Core/Plugin.php:90`
- `apd_inquiry_logged | src/Contact/InquiryTracker.php:196`
- `apd_inquiry_marked_read | src/Contact/InquiryTracker.php:505`
- `apd_inquiry_marked_unread | src/Contact/InquiryTracker.php:530`
- `apd_inquiry_tracker_init | src/Contact/InquiryTracker.php:104`
- `apd_listing_cache_invalidated | src/Core/Performance.php:624`
- `apd_listing_card_body | templates/listing-card-list.php:196`
- `apd_listing_card_body | templates/listing-card.php:195`
- `apd_listing_card_end | templates/listing-card-list.php:249`
- `apd_listing_card_end | templates/listing-card.php:228`
- `apd_listing_card_footer | templates/listing-card-list.php:231`
- `apd_listing_card_footer | templates/listing-card.php:211`
- `apd_listing_card_image | templates/listing-card-list.php:126`
- `apd_listing_card_image | templates/listing-card.php:133`
- `apd_listing_card_start | templates/listing-card-list.php:100`
- `apd_listing_card_start | templates/listing-card.php:93`
- `apd_listing_fields_saved | src/Frontend/Submission/SubmissionHandler.php:957`
- `apd_listing_processed | includes/functions.php:2039`
- `apd_listing_saved | src/Frontend/Submission/SubmissionHandler.php:770`
- `apd_listing_status_changed | src/Core/Plugin.php:414`
- `apd_listing_taxonomies_assigned | src/Frontend/Submission/SubmissionHandler.php:859`
- `apd_listing_type_registered | src/Taxonomy/ListingTypeTaxonomy.php:197`
- `apd_listing_viewed | includes/functions.php:1435`
- `apd_loaded | src/Core/Plugin.php:275`
- `apd_module_registered | src/Module/ModuleRegistry.php:230`
- `apd_module_unregistered | src/Module/ModuleRegistry.php:289`
- `apd_modules_admin_init | src/Module/ModulesAdminPage.php:108`
- `apd_modules_init | src/Module/ModuleRegistry.php:127`
- `apd_modules_loaded | src/Module/ModuleRegistry.php:136`
- `apd_my_listings_end | templates/dashboard/my-listings.php:196`
- `apd_my_listings_start | templates/dashboard/my-listings.php:46`
- `apd_profile_end | templates/dashboard/profile.php:249`
- `apd_profile_saved | src/Frontend/Dashboard/Profile.php:366`
- `apd_profile_start | templates/dashboard/profile.php:44`
- `apd_rating_calculated | src/Review/RatingCalculator.php:197`
- `apd_rating_calculator_init | src/Review/RatingCalculator.php:135`
- `apd_rating_invalidated | src/Review/RatingCalculator.php:342`
- `apd_register_filters | src/Core/Plugin.php:674`
- `apd_register_form_fields | src/Shortcode/RegisterFormShortcode.php:235`
- `apd_register_rest_routes | src/Api/RestController.php:165`
- `apd_register_settings | src/Admin/Settings.php:245`
- `apd_render_review_form | templates/review/reviews-section.php:114`
- `apd_rest_after_create_listing | src/Api/Endpoints/ListingsEndpoint.php:370`
- `apd_rest_after_delete_listing | src/Api/Endpoints/ListingsEndpoint.php:559`
- `apd_rest_after_update_listing | src/Api/Endpoints/ListingsEndpoint.php:498`
- `apd_rest_api_init | src/Api/RestController.php:130`
- `apd_rest_before_create_listing | src/Api/Endpoints/ListingsEndpoint.php:316`
- `apd_rest_before_delete_listing | src/Api/Endpoints/ListingsEndpoint.php:536`
- `apd_rest_before_update_listing | src/Api/Endpoints/ListingsEndpoint.php:440`
- `apd_rest_endpoint_registered | src/Api/RestController.php:226`
- `apd_rest_endpoint_unregistered | src/Api/RestController.php:251`
- `apd_rest_routes_registered | src/Api/RestController.php:181`
- `apd_review_approved | src/Review/ReviewManager.php:670`
- `apd_review_created | src/Review/ReviewManager.php:298`
- `apd_review_deleted | src/Review/ReviewManager.php:448`
- `apd_review_display_init | src/Review/ReviewDisplay.php:117`
- `apd_review_form_before_submit | templates/review/review-form.php:285`
- `apd_review_form_created | src/Review/ReviewHandler.php:408`
- `apd_review_form_end | templates/review/review-form.php:311`
- `apd_review_form_init | src/Review/ReviewForm.php:138`
- `apd_review_form_start | templates/review/review-form.php:166`
- `apd_review_form_updated | src/Review/ReviewHandler.php:372`
- `apd_review_handler_init | src/Review/ReviewHandler.php:120`
- `apd_review_item_footer | templates/review/review-item.php:113`
- `apd_review_rejected | src/Review/ReviewManager.php:701`
- `apd_review_updated | src/Review/ReviewManager.php:406`
- `apd_reviews_init | src/Review/ReviewManager.php:138`
- `apd_reviews_section_after_form | templates/review/reviews-section.php:127`
- `apd_reviews_section_after_header | templates/review/reviews-section.php:79`
- `apd_reviews_section_before_form | templates/review/reviews-section.php:99`
- `apd_reviews_section_end | templates/review/reviews-section.php:166`
- `apd_reviews_section_start | templates/review/reviews-section.php:52`
- `apd_search_query_modified | src/Search/SearchQuery.php:176`
- `apd_settings_init | src/Admin/Settings.php:142`
- `apd_shortcode_registered | src/Shortcode/ShortcodeManager.php:154`
- `apd_shortcode_unregistered | src/Shortcode/ShortcodeManager.php:186`
- `apd_shortcodes_init | src/Shortcode/ShortcodeManager.php:123`
- `apd_single_listing_after_content | src/Core/TemplateLoader.php:497`
- `apd_single_listing_after_content | templates/single-listing.php:197`
- `apd_single_listing_after_fields | src/Core/TemplateLoader.php:526`
- `apd_single_listing_after_fields | templates/single-listing.php:224`
- `apd_single_listing_author | templates/single-listing.php:314`
- `apd_single_listing_before_content | templates/single-listing.php:179`
- `apd_single_listing_contact_form | src/Core/TemplateLoader.php:552`
- `apd_single_listing_contact_form | templates/single-listing.php:328`
- `apd_single_listing_end | templates/single-listing.php:354`
- `apd_single_listing_header | templates/single-listing.php:143`
- `apd_single_listing_image | templates/single-listing.php:166`
- `apd_single_listing_meta | src/Core/TemplateLoader.php:501`
- `apd_single_listing_meta | templates/single-listing.php:131`
- `apd_single_listing_reviews | src/Core/TemplateLoader.php:636`
- `apd_single_listing_reviews | templates/comments-listing.php:42`
- `apd_single_listing_reviews | templates/single-listing.php:253`
- `apd_single_listing_sidebar_end | templates/single-listing.php:339`
- `apd_single_listing_sidebar_start | templates/single-listing.php:268`
- `apd_single_listing_start | templates/single-listing.php:87`
- `apd_single_wrapper_end | templates/single-listing.php:417`
- `apd_single_wrapper_start | templates/single-listing.php:37`
- `apd_submission_form_after_basic_fields | templates/submission/submission-form.php:250`
- `apd_submission_form_after_custom_fields | templates/submission/submission-form.php:274`
- `apd_submission_form_after_image | templates/submission/submission-form.php:343`
- `apd_submission_form_after_taxonomies | templates/submission/submission-form.php:317`
- `apd_submission_form_before_submit | templates/submission/submission-form.php:397`
- `apd_submission_form_end | templates/submission/submission-form.php:415`
- `apd_submission_form_start | templates/submission/submission-form.php:81`
- `apd_textdomain_loaded | src/Core/Plugin.php:308`
- `apd_user_registered | src/Shortcode/RegisterFormShortcode.php:326`
- `apd_validate_review | src/Review/ReviewHandler.php:484`
- `apd_validate_submission | src/Frontend/Submission/SubmissionHandler.php:586`
- `apd_view_registered | src/Frontend/Display/ViewRegistry.php:153`
- `apd_view_unregistered | src/Frontend/Display/ViewRegistry.php:182`
- `apd_views_init | src/Frontend/Display/ViewRegistry.php:126`
