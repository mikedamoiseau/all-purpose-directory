 ...
 * Override this template in your theme: damdir-directory/emails/listing-submitted.php
 *
...
<h2><?php esc_html_e( 'New Listing Submitted', 'damdir-directory' ); ?></h2>

<p><?php esc_html_e( 'A new listing has been submitted and is awaiting your review.', 'damdir-directory' ); ?></p>

<table class="info-table">
	<tr>
		<td><?php esc_html_e( 'Title', 'damdir-directory' ); ?></td>
		<td><?php echo esc_html( $listing_title ); ?></td>
	</tr>
	<tr>
		<td><?php esc_html_e( 'Author', 'damdir-directory' ); ?></td>
	...
	<tr>
		<td><?php esc_html_e( 'Submitted', 'damdir-directory' ); ?></td>
		<td><?php echo esc_html( wp_date( get_option( 'date_format' ) . ' ' . get_option( 'time_format' ) ) ); ?></td>
	</tr>
</table>

<div class="text-center mt-20">
	<a href="<?php echo esc_url( $listing_edit_url ); ?>" class="button"><?php esc_html_e( 'Review Listing', 'damdir-directory' ); ?></a>
	<a href="<?php echo esc_url( $listing_url ); ?>" class="button button-secondary"><?php esc_html_e( 'View Listing', 'damdir-directory' ); ?></a>
</div>

<p class="text-center text-muted mt-20">
	<a href="<?php echo esc_url( $admin_url ); ?>"><?php esc_html_e( 'Manage All Listings', 'damdir-directory' ); ?></a>
</p>
