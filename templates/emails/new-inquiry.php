 ...
 * Override this template in your theme: damdir-directory/emails/new-inquiry.php
 *
...
<h2><?php esc_html_e( 'New Inquiry About Your Listing', 'damdir-directory' ); ?></h2>
...
<p><?php esc_html_e( 'You have received a new inquiry about your listing. Here are the details:', 'damdir-directory' ); ?></p>
...
<h3 style="margin-top: 25px; margin-bottom: 10px;"><?php esc_html_e( 'Message:', 'damdir-directory' ); ?></h3>
...
<div class="text-center mt-20">
	<a href="mailto:<?php echo esc_attr( $inquiry_email ); ?>?subject=<?php echo esc_attr( rawurlencode( 'Re: ' . $listing_title ) ); ?>" class="button"><?php esc_html_e( 'Reply to Inquiry', 'damdir-directory' ); ?></a>
</div>

<p class="text-muted mt-20"><?php esc_html_e( 'Responding quickly to inquiries can help convert potential customers. We recommend replying within 24 hours.', 'damdir-directory' ); ?></p>
