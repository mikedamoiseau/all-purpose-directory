 ...
 * yourtheme/damdir-directory/search/no-results.php
 *
...
<div class="apd-no-results">
	...
	<h2 class="apd-no-results__title">
		<?php esc_html_e( 'No listings found', 'damdir-directory' ); ?>
	</h2>

	<p class="apd-no-results__message">
		<?php esc_html_e( 'No listings match your current search criteria. Try adjusting your filters or search terms.', 'damdir-directory' ); ?>
	</p>
